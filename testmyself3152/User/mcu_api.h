...
unsigned char mcu_dp_bool_mesh_update(unsigned char dpid,unsigned char value);
unsigned char mcu_dp_enum_mesh_update(unsigned char dpid,unsigned char value);
/*****************************************************************************
...
unsigned char mcu_dp_value_mesh_update(unsigned char dpid,unsigned long value);
/*****************************************************************************
