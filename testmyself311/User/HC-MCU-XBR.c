...
unsigned char xdata guc_Read_a[6] = {0x00};			//用于存放读取的数据
...
// 	P0M3 = P0M3&0xF0|0x08;		      //P06设置为推挽输出
	...
	P0M0 = P0M0&0xF0|0x08;		          //P00设置为推挽输出     没有使用
...
//	P0M0 = P0M0&0x0F|0x80;		          //P01设置为推挽输出
	...
	P0M2 = P0M2&0x0F|0x80;		      //P05设置为推挽输出         没有使用
...
void set_var(void)
{
	...
	Flash_ReadArr(0X2f00,6,guc_Read_a);	//读取地址0x2F00所在扇区
